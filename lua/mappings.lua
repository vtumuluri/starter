...
map("n", "<leader>yx", "<cmd> TroubleToggle <CR>", { desc = "Toggle Trouble" })
map("n", "<leader>yw", "<cmd> TroubleToggle workspace_diagnostics<CR>", { desc = "Workspace Diagnostics" })
map("n", "<leader>yd", "<cmd> TroubleToggle document_diagnostics<CR>", { desc = "Document Diagnostics" })
map("n", "<leader>yq", "<cmd> TroubleToggle quickfix<CR>", { desc = "QuickFix" })
map("n", "<leader>yl", "<cmd> TroubleToggle loclist<CR>", { desc = "LocList" })
map("n", "gR", "<cmd> TroubleToggle lsp_references<CR>", { desc = "Trouble LSP References" })

-- DAP Key mappings
map("n", "<F5>", function() require('dap').continue() end, { desc = 'Launch Debug' })
...
map("n", "<Leader>B", function() require('dap').set_breakpoint() end, { desc = 'Set Breakpoint' })
...
map("n", "<Leader>dh", function() require('dap.ui.widgets').hover() end, { desc = 'Hover debug widgets' })
map("n", "<Leader>dp", function() require('dap.ui.widgets').preview() end, { desc = 'Preview debug widgets' })

-- VISUAL MODE

map("v", "<Leader>dh", function() require('dap.ui.widgets').hover() end, { desc = 'Hover debug widgets' })
map("v", "<Leader>dp", function() require('dap.ui.widgets').preview() end, { desc = 'Preview debug widgets' })
